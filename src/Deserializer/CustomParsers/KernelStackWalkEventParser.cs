...
internal sealed class KernelStackWalkEventParser : ICustomParser
{
    ...
    {
        EventTimeStampMetadata = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_INT64,
            _TDH_OUT_TYPE.TDH_OUTTYPE_UNSIGNEDLONG, "EventTimeStamp", false, false, 0, null);
        StackProcessMetadata = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_INT32,
            _TDH_OUT_TYPE.TDH_OUTTYPE_UNSIGNEDINT, "StackProcess", false, false, 0, null);
        StackThreadMetadata = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_INT32, _TDH_OUT_TYPE.TDH_OUTTYPE_UNSIGNEDINT,
            "StackThread", false, false, 0, null);
        StacksPropertyMetadata = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_POINTER,
            _TDH_OUT_TYPE.TDH_OUTTYPE_HEXINT64, "Stacks", false, false, 0, null);
