...
internal sealed class KernelTraceControlDbgIdParser : ICustomParser
{
    ...
    {
        ImageBase = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_INT64, _TDH_OUT_TYPE.TDH_OUTTYPE_HEXINT64, "ImageBase",
            false, false, 0, null);
        ProcessId = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_UINT32, _TDH_OUT_TYPE.TDH_OUTTYPE_UNSIGNEDINT,
            "ProcessID", false, false, 0, null);
        GuidSig = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_GUID, _TDH_OUT_TYPE.TDH_OUTTYPE_GUID, "GuidSig", false,
            false, 0, null);
        Age = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_UINT32, _TDH_OUT_TYPE.TDH_OUTTYPE_UNSIGNEDINT, "Age", false,
            false, 0, null);
        PdbFileName = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_UNICODESTRING, _TDH_OUT_TYPE.TDH_OUTTYPE_STRING,
            "PdbFileName", false, false, 0, null);
