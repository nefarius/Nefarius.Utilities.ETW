...
internal sealed class KernelTraceControlImageIdParser : ICustomParser
{
    ...
    {
        ImageBase = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_POINTER, _TDH_OUT_TYPE.TDH_OUTTYPE_HEXINT64,
            "ImageBase", false, false, 0, null);
        ImageSize = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_UINT32, _TDH_OUT_TYPE.TDH_OUTTYPE_UNSIGNEDINT,
            "ImageSize", false, false, 0, null);
        TimeDateStamp = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_UINT32, _TDH_OUT_TYPE.TDH_OUTTYPE_UNSIGNEDINT,
            "TimeDateStamp", false, false, 0, null);
        OriginalFileName = new PropertyMetadata(_TDH_IN_TYPE.TDH_INTYPE_UNICODESTRING, _TDH_OUT_TYPE.TDH_OUTTYPE_STRING,
            "OriginalFileName", false, false, 0, null);
