...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ValueMapValueTypeSerializer](./microsoft.xml.serialization.generatedassembly.valuemapvaluetypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ValueMapValueTypeSerializer()**

```csharp
public ValueMapValueTypeSerializer()
```
