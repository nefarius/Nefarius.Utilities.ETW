# TemplateItemTypeBinarySerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [TemplateItemTypeBinarySerializer](./microsoft.xml.serialization.generatedassembly.templateitemtypebinaryserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**TemplateItemTypeBinarySerializer()**

```csharp
public TemplateItemTypeBinarySerializer()
```
