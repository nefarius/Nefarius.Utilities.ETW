...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [LevelTypeSerializer](./microsoft.xml.serialization.generatedassembly.leveltypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**LevelTypeSerializer()**
