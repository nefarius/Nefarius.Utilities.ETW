...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [KeywordListTypeSerializer](./microsoft.xml.serialization.generatedassembly.keywordlisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**KeywordListTypeSerializer()**

```csharp
public KeywordListTypeSerializer()
```
