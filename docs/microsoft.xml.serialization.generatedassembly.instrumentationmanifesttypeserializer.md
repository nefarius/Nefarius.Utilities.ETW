# InstrumentationManifestTypeSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [InstrumentationManifestTypeSerializer](./microsoft.xml.serialization.generatedassembly.instrumentationmanifesttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**InstrumentationManifestTypeSerializer()**

```csharp
public InstrumentationManifestTypeSerializer()
```
