...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [MetadataTypeSerializer](./microsoft.xml.serialization.generatedassembly.metadatatypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**MetadataTypeSerializer()**

```csharp
public MetadataTypeSerializer()
```
