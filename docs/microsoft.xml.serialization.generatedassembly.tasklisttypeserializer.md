...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [TaskListTypeSerializer](./microsoft.xml.serialization.generatedassembly.tasklisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**TaskListTypeSerializer()**

```csharp
public TaskListTypeSerializer()
```
