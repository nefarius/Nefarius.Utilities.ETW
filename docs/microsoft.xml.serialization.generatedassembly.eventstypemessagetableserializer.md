# EventsTypeMessageTableSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [EventsTypeMessageTableSerializer](./microsoft.xml.serialization.generatedassembly.eventstypemessagetableserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**EventsTypeMessageTableSerializer()**

```csharp
public EventsTypeMessageTableSerializer()
```
