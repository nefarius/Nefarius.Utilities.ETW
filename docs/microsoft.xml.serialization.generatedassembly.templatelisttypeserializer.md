...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [TemplateListTypeSerializer](./microsoft.xml.serialization.generatedassembly.templatelisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**TemplateListTypeSerializer()**

```csharp
public TemplateListTypeSerializer()
```
