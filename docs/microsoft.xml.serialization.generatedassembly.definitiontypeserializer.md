...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [DefinitionTypeSerializer](./microsoft.xml.serialization.generatedassembly.definitiontypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**DefinitionTypeSerializer()**

```csharp
public DefinitionTypeSerializer()
```
