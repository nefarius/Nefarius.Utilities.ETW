...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [FilterListTypeSerializer](./microsoft.xml.serialization.generatedassembly.filterlisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**FilterListTypeSerializer()**

```csharp
public FilterListTypeSerializer()
```
