...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ValueMapTypeSerializer](./microsoft.xml.serialization.generatedassembly.valuemaptypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ValueMapTypeSerializer()**

```csharp
public ValueMapTypeSerializer()
```
