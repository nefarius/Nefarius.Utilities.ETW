...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ChannelLoggingTypeSerializer](./microsoft.xml.serialization.generatedassembly.channelloggingtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ChannelLoggingTypeSerializer()**

```csharp
public ChannelLoggingTypeSerializer()
```
