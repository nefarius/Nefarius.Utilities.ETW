# instrumentationManifestSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [instrumentationManifestSerializer](./microsoft.xml.serialization.generatedassembly.instrumentationmanifestserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**instrumentationManifestSerializer()**

```csharp
public instrumentationManifestSerializer()
```
