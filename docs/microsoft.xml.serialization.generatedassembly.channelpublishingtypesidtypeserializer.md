# ChannelPublishingTypeSidTypeSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ChannelPublishingTypeSidTypeSerializer](./microsoft.xml.serialization.generatedassembly.channelpublishingtypesidtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ChannelPublishingTypeSidTypeSerializer()**

```csharp
public ChannelPublishingTypeSidTypeSerializer()
```
