# ChannelPublishingTypeSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ChannelPublishingTypeSerializer](./microsoft.xml.serialization.generatedassembly.channelpublishingtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ChannelPublishingTypeSerializer()**

```csharp
public ChannelPublishingTypeSerializer()
```
