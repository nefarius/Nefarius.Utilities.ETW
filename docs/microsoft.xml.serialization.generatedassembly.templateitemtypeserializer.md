...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [TemplateItemTypeSerializer](./microsoft.xml.serialization.generatedassembly.templateitemtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**TemplateItemTypeSerializer()**

```csharp
public TemplateItemTypeSerializer()
```
