...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [NamedQueryTypeSerializer](./microsoft.xml.serialization.generatedassembly.namedquerytypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**NamedQueryTypeSerializer()**

```csharp
public NamedQueryTypeSerializer()
```
