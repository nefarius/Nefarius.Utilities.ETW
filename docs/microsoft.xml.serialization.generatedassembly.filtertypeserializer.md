...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [FilterTypeSerializer](./microsoft.xml.serialization.generatedassembly.filtertypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**FilterTypeSerializer()**

```csharp
public FilterTypeSerializer()
```
