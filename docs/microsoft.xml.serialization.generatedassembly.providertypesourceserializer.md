...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ProviderTypeSourceSerializer](./microsoft.xml.serialization.generatedassembly.providertypesourceserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ProviderTypeSourceSerializer()**

```csharp
public ProviderTypeSourceSerializer()
```
