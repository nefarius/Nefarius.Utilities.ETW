...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [InputTypeSerializer](./microsoft.xml.serialization.generatedassembly.inputtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**InputTypeSerializer()**

```csharp
public InputTypeSerializer()
```
