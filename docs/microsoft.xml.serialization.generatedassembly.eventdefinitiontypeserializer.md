...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [EventDefinitionTypeSerializer](./microsoft.xml.serialization.generatedassembly.eventdefinitiontypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**EventDefinitionTypeSerializer()**

```csharp
public EventDefinitionTypeSerializer()
```
