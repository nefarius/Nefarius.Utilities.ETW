# LocalizationTypeResourcesSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [LocalizationTypeResourcesSerializer](./microsoft.xml.serialization.generatedassembly.localizationtyperesourcesserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**LocalizationTypeResourcesSerializer()**

```csharp
public LocalizationTypeResourcesSerializer()
```
