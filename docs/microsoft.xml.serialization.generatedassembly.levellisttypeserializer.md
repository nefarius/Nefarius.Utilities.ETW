...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [LevelListTypeSerializer](./microsoft.xml.serialization.generatedassembly.levellisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**LevelListTypeSerializer()**

```csharp
public LevelListTypeSerializer()
```
