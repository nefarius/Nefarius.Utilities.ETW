...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [LocalizationTypeSerializer](./microsoft.xml.serialization.generatedassembly.localizationtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**LocalizationTypeSerializer()**

```csharp
public LocalizationTypeSerializer()
```
