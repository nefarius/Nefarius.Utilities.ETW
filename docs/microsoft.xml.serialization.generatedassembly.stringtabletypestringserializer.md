# StringTableTypeStringSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [StringTableTypeStringSerializer](./microsoft.xml.serialization.generatedassembly.stringtabletypestringserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**StringTableTypeStringSerializer()**

```csharp
public StringTableTypeStringSerializer()
```
