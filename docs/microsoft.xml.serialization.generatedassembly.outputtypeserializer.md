...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [OutputTypeSerializer](./microsoft.xml.serialization.generatedassembly.outputtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**OutputTypeSerializer()**

```csharp
public OutputTypeSerializer()
```
