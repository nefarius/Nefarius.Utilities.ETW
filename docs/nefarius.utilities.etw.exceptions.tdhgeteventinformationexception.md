# TdhGetEventInformationException
...
Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/dotnet/api/system.exception) → [SystemException](https://learn.microsoft.com/dotnet/api/system.systemexception) → [ExternalException](https://learn.microsoft.com/dotnet/api/system.runtime.interopservices.externalexception) → [Win32Exception](https://learn.microsoft.com/dotnet/api/system.componentmodel.win32exception) → [TdhGetEventInformationException](./nefarius.utilities.etw.exceptions.tdhgeteventinformationexception.md)<br>
