...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [OpcodeTypeSerializer](./microsoft.xml.serialization.generatedassembly.opcodetypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**OpcodeTypeSerializer()**

```csharp
public OpcodeTypeSerializer()
```
