# StructDefinitionTypeSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [StructDefinitionTypeSerializer](./microsoft.xml.serialization.generatedassembly.structdefinitiontypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**StructDefinitionTypeSerializer()**

```csharp
public StructDefinitionTypeSerializer()
```
