...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ProviderTypeSerializer](./microsoft.xml.serialization.generatedassembly.providertypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ProviderTypeSerializer()**

```csharp
public ProviderTypeSerializer()
```
