# ChannelTypeIsolationSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ChannelTypeIsolationSerializer](./microsoft.xml.serialization.generatedassembly.channeltypeisolationserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ChannelTypeIsolationSerializer()**

```csharp
public ChannelTypeIsolationSerializer()
```
