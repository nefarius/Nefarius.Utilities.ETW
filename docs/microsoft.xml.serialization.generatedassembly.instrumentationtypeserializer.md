...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [InstrumentationTypeSerializer](./microsoft.xml.serialization.generatedassembly.instrumentationtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**InstrumentationTypeSerializer()**

```csharp
public InstrumentationTypeSerializer()
```
