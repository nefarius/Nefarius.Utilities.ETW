...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [PatternMapValueTypeSerializer](./microsoft.xml.serialization.generatedassembly.patternmapvaluetypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**PatternMapValueTypeSerializer()**

```csharp
public PatternMapValueTypeSerializer()
```
