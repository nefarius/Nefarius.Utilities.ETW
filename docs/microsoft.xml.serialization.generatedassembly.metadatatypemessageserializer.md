...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [MetadataTypeMessageSerializer](./microsoft.xml.serialization.generatedassembly.metadatatypemessageserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**MetadataTypeMessageSerializer()**

```csharp
public MetadataTypeMessageSerializer()
```
