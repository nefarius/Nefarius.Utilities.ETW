...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ChannelListTypeSerializer](./microsoft.xml.serialization.generatedassembly.channellisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ChannelListTypeSerializer()**

```csharp
public ChannelListTypeSerializer()
```
