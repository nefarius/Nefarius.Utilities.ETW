...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [KeywordTypeSerializer](./microsoft.xml.serialization.generatedassembly.keywordtypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**KeywordTypeSerializer()**
