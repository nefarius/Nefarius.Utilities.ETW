...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [TaskTypeSerializer](./microsoft.xml.serialization.generatedassembly.tasktypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**TaskTypeSerializer()**

```csharp
public TaskTypeSerializer()
```
