...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [StringTableTypeSerializer](./microsoft.xml.serialization.generatedassembly.stringtabletypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**StringTableTypeSerializer()**

```csharp
public StringTableTypeSerializer()
```
