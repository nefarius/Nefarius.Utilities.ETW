# ChannelPublishingTypeClockTypeSerializer
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ChannelPublishingTypeClockTypeSerializer](./microsoft.xml.serialization.generatedassembly.channelpublishingtypeclocktypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ChannelPublishingTypeClockTypeSerializer()**

```csharp
public ChannelPublishingTypeClockTypeSerializer()
```
