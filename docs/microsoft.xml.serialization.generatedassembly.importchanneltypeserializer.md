...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ImportChannelTypeSerializer](./microsoft.xml.serialization.generatedassembly.importchanneltypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ImportChannelTypeSerializer()**

```csharp
public ImportChannelTypeSerializer()
```
