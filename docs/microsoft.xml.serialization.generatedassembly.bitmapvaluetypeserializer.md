...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [BitMapValueTypeSerializer](./microsoft.xml.serialization.generatedassembly.bitmapvaluetypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**BitMapValueTypeSerializer()**

```csharp
public BitMapValueTypeSerializer()
```
