...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [BitMapTypeSerializer](./microsoft.xml.serialization.generatedassembly.bitmaptypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**BitMapTypeSerializer()**

```csharp
public BitMapTypeSerializer()
```
