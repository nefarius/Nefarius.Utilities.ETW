...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [OpcodeListTypeSerializer](./microsoft.xml.serialization.generatedassembly.opcodelisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**OpcodeListTypeSerializer()**

```csharp
public OpcodeListTypeSerializer()
```
