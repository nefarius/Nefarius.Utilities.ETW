...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [DataDefinitionTypeSerializer](./microsoft.xml.serialization.generatedassembly.datadefinitiontypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**DataDefinitionTypeSerializer()**

```csharp
public DataDefinitionTypeSerializer()
```
