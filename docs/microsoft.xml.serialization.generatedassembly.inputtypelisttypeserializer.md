...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [InputTypeListTypeSerializer](./microsoft.xml.serialization.generatedassembly.inputtypelisttypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**InputTypeListTypeSerializer()**

```csharp
public InputTypeListTypeSerializer()
```
