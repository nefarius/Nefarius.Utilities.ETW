...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → XmlSerializer → [XmlSerializer1](./microsoft.xml.serialization.generatedassembly.xmlserializer1.md) → [ChannelTypeTypeSerializer](./microsoft.xml.serialization.generatedassembly.channeltypetypeserializer.md)

## Constructors

### <a id="constructors-.ctor"/>**ChannelTypeTypeSerializer()**

```csharp
public ChannelTypeTypeSerializer()
```
